...
describe('utils', () => {
  ...
  describe('fetchDiagnostics', () => {
    ...
    it('should fetch and return diagnostics data successfully', async () => {
      const mockResponse = {
        ok: true,
    ...
    it('should throw error when response is not ok', async () => {
      ...
      await expect(
        fetchDiagnostics('https://api.example.com/diagnostics'),
      ).rejects.toThrow('Failed to fetch diagnostics: Not Found');
    });
